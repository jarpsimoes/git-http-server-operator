...
import (
	...
	jarpsimoesgithubiov1alpha1 "github.com/jarpsimoes/git-http-server-operator/api/v1alpha1"
)

// GitHttpServerReconciler reconciles a GitHttpServer object
type GitHttpServerReconciler struct {
	client.Client
...
func (r *GitHttpServerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := log.FromContext(ctx).WithValues("GitHttpServer", req.NamespacedName)

	instance := &jarpsimoesgithubiov1alpha1.GitHttpServer{}
...
func (r *GitHttpServerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&jarpsimoesgithubiov1alpha1.GitHttpServer{}).
		Complete(r)
}
